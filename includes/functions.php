...
function dh_morphsearchform(){
	...
	<div class="morphsearch" id="morphsearch">
		<form class="morphsearch-form" method="get"  action="<?php echo esc_url( home_url( '/' ) ) ?>" role="form">
			<input type="search" name="s" placeholder="<?php esc_attr_e('Search...','sitesao')?>" class="morphsearch-input">
		...
		<div class="mailchimp-form-content clearfix">
			<div class="row">
				<div class="col-sm-8">
					...
					<input type="email" class="form-control"  required="required" autocomplete="off" placeholder="<?php esc_attr_e('Enter your email...','sitesao')?>" name="email">
				</div>
				<div class="col-sm-4">
